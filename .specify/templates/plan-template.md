...
**ملاحظة**: يُملأ هذا القالب بأمر /speckit-plan. للتسلسل التنفيذي راجع `.specify/templates/plan-template.md`.
...
```text
specs/[###-feature]/
├── plan.md              # هذا الملف (مخرجات /speckit-plan)
├── research.md          # مرحلة 0 (/speckit-plan)
├── data-model.md        # مرحلة 1 (/speckit-plan)
├── quickstart.md        # مرحلة 1 (/speckit-plan)
├── contracts/           # مرحلة 1 (/speckit-plan)
└── tasks.md             # مرحلة 2 (/speckit-tasks — لا يُنشأ بـ /speckit-plan)
```
